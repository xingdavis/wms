...
public class UserCookieUtil {
	...
	public static void saveCookie(User user, HttpServletResponse response) throws Exception {
		...
		String cookieValueWithMd5 = MD5.md5crypt(user.getUname()+ ":"+ user.getUname() + ":" + validTime + ":" + Const.WEBKEY);
		// 将要被保存的完整的Cookie值
		String cookieValue = user.getUname() + ":" + validTime +":"+cookieValueWithMd5;
