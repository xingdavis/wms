	...
	<div region="center" border="false" style="overflow: hidden;">
		...
		<div id="dlg" class="easyui-dialog"
			...
			<form id="fm" method="post" novalidate>
				<div class="fitem">
					<label>用户名:</label> <input name="uname" class="easyui-textbox" required="true">
				</div>
				<div class="fitem">
					<label>密码:</label> <input name="pwd" class="easyui-textbox" required="true">
				</div>
				<div class="fitem">
					<label>年龄:</label> <input name="age" class="easyui-textbox" required="true">
				</div>
				<div class="fitem">
					<label>角色:</label> 
					<input type="radio" name="gender" id="gender" value="1" style="width:50px;">普通</input>
					<input type="radio" name="gender" id="gender" value="0" style="width:50px;">管理</input>
				</div>
			</form>
		</div>
		...
		<div id="dlgsearch" class="easyui-dialog"
			...
			<form id="fmsearch" method="post" novalidate>
				...
				<div class="fitem">
					...
					<input type="radio" name="gender" id="gender" value="1" style="width:30px;">普通</input>
					<input type="radio" name="gender" id="gender" value="0" style="width:30px;">管理</input>
				</div>
			</form>
		</div>
